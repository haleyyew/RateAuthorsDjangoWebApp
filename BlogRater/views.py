...
def index(request):
    ...
    context_dict = {'boldmessage': "Please search for a blog by entering its url and view all posts. Click on one of the posts to view the content of that post. Then click on \"View Ratings\" to rate the author of that post.",
